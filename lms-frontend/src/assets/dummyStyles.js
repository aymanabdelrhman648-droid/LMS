export const bannerStyles = {
  // Layout and container styles  ehp[]
...
export const homeCoursesStyles = {
  ...
  courseImage:
  "w-full h-48 sm:h-48 md:h-40 lg:h-48 object-cover transition-transform duration-300 group-hover:shadow-[0_8px_32px_0_rgba(99,102,241,0.18)]",
