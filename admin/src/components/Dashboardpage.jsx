...
import {Users , ShoppingCart , BookMarked , BadgeIndianRupee, BookOpenIcon, BookOpenText, Search} from 'lucide-react'
          ...
          <div className={dashboardStyles.contentContainer}>
                <div className={dashboardStyles.headerContainer}>
                     ...
                     <p className={dashboardStyles.headerSubtitle}>
                      welcome back, here is a quick overview of your course performance and sales metrics. Dive in to see detailed insights and manage your courses effectively.
                     </p>
                </div>
                ...
                <div className={dashboardStyles.statsGrid}>
                    {stats.map((stat,index)=>{
                          const Icon = stat.icon || iconMap.Users;
                           return(
