...
const ListPage = () => {
  ...
  const fetchCourses = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`${API_BASE}/api/course/puplic`);
      let raw = res.data;
    ...
    <div className={listStyles.pageContainer}>
        ...
        <div className={listStyles.contentContainer}> 
            <div className={listStyles.headerContainer}>
                  <h1 className={listStyles.headerTitle}>Course Catalouge</h1> 
                  <p className={listStyles.headerSubtitle}>
                    Manage your courses, edit details, and keep your catalog up to date. Click on a course to view more information and make changes as needed.
                  </p>
            </div>
            ...
            filteredCourses.map((course) => (
             ...
             {!loading && filteredCourses.length === 0 && (
              <div className={listStyles.emptyText}>
                No courses found. Try adjusting your search or add new courses.
              </div>
            )}
            </div>
